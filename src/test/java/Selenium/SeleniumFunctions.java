...
public class SeleniumFunctions {
	...
	InterruptedException {
		System.setProperty("webdriver.chrome.driver","C:\\Users\\anshu\\IdeaProjects\\TestAutomation\\drivers\\chromedriver.exe");
		...
		public void ishomepageDisplayed() {
			...
			driver.findElement(By.className("text-bold text-white no-underline"))
			.isDisplayed();
			}
